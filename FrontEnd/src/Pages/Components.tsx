...
const Components = () => {
  return (
    ...
    <div  className="min-h-[80%] w-[100%] grid lg:grid-cols-4 gap-2 mt-9 md:grid-cols-3 sm:grid-cols-2">
     <Link to="/HeaderComp">
   ...
   <div className="rounded-md h-[250px] shadow-md flex items-center flex-col hover:bg-[#F9FAFB] transition-all duration-300 cursor-pointer">
        ...
        <div className="w-[95%] h-[25%]">
          <div className="font-[700] hover:text-[blue] transition-all duration-300">Toggle Layouts</div>
          <div className="font-[grey] text-[13px] font-[500]">2 Components</div>
        </div>
      </div>
   </Link>
     </div>
     ...
     <div className="rounded-md h-[250px] shadow-md flex items-center flex-col hover:bg-[#F9FAFB] transition-all duration-300 cursor-pointer">
        ...
        <div className="w-[95%] h-[25%]">
          <div className="font-[700] hover:text-[blue] transition-all duration-300">Footer Layouts</div>
          <div className="font-[grey] text-[13px] font-[500]">4 Components</div>
        </div>
      </div>
     </Link>
     ...
     <div className="rounded-md h-[250px] shadow-md flex items-center flex-col hover:bg-[#F9FAFB] transition-all duration-300 cursor-pointer">
        ...
        <div className="w-[95%] h-[25%]">
          <div className="font-[700] hover:text-[blue] transition-all duration-300">Contact Layouts</div>
          <div className="font-[grey] text-[13px] font-[500]">2 Components</div>
        </div>
      </div>
     </Link>
